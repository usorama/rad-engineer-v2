...
import { registerRadEngineerHandlers } from './rad-engineer-handlers';
...
export function setupIpcHandlers(
  ...
  // Rad-Engineer integration handlers (for end-to-end testing)
  registerRadEngineerHandlers(getMainWindow);
