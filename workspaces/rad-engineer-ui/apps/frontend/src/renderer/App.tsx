...
export function App() {
  ...
  // GitHub setup state (shown after rad-engineer init)
  ...
  const handleInitialize = async () => {
    ...
    try {
      ...
      if (result?.success) {
        ...
        const errorMessage = result?.error || 'Failed to initialize rad-engineer. Please try again.';
  ...
  return (
    <ViewStateProvider>
      ...
      <div className="flex h-screen bg-background">
        ...
        {/* GitHub Setup Modal - shows after rad-engineer init to configure GitHub */}
        {gitHubSetupProject && (
          <GitHubSetupModal
