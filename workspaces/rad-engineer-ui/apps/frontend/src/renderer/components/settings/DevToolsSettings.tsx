      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            {t('devtools.ide.description', 'rad-engineer will open worktrees in this editor')}
          </p>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            {t('devtools.terminal.description', 'rad-engineer will open terminal sessions here')}
          </p>
