          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="auto-claude">{t('general.agentFrameworkRadEngineer')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-3">
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <Label htmlFor="autoBuildPath" className="text-sm font-medium text-foreground">{t('general.radEngineerPath')}</Label>
          <p className="text-sm text-muted-foreground">{t('general.radEngineerPathDescription')}</p>
          <Input
            id="autoBuildPath"
            placeholder={t('general.radEngineerPathPlaceholder')}
            className="w-full max-w-lg"
