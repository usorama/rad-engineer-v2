...
async function initializePythonEnvForPR(
  ...
  if (!autoBuildSource) {
    return 'Python environment not ready and rad-engineer source not found';
  }
      ...
      try {
        ...
        if (!pythonEnvManager.isEnvReady()) {
          ...
          if (autoBuildSource) {
            ...
            return { success: false, error: 'Python environment not ready and rad-engineer source not found' };
          }
        }
        ...
        if (!sourcePath) {
          return { success: false, error: 'rad-engineer source not found' };
        }
      ...
      try {
        ...
        if (!pythonEnvManager.isEnvReady()) {
          ...
          if (autoBuildSource) {
            ...
            console.error('[IPC] rad-engineer source not found');
            return { success: false, error: 'Python environment not ready and rad-engineer source not found' };
          }
        }
