...
// GitLab integration
  ...
  // rad-engineer source environment configuration
  ...
  // Execution operations (wave-based atomic swarm execution)
  EXECUTION_GET_WAVE_STATUS: 'execution:getWaveStatus',
  EXECUTION_WAVE_PROGRESS: 'execution:waveProgress',
  EXECUTION_GET_QUALITY_GATES: 'execution:getQualityGates',
  EXECUTION_QUALITY_GATE_RESULT: 'execution:qualityGateResult',
  EXECUTION_GET_AGENT_STATUS: 'execution:getAgentStatus',
  EXECUTION_AGENT_PROGRESS: 'execution:agentProgress',
  EXECUTION_GET_STATE_MACHINE_STATUS: 'execution:getStateMachineStatus',
  EXECUTION_STATE_CHANGED: 'execution:stateChanged',

  // Planning operations (Phase 0 - Planning skill)
  PLANNING_START_INTAKE: 'rad-engineer:planning-start-intake',
  PLANNING_SUBMIT_ANSWERS: 'rad-engineer:planning-submit-answers',
  PLANNING_GET_QUESTIONS: 'rad-engineer:planning-get-questions',
  PLANNING_START_RESEARCH: 'rad-engineer:planning-start-research',
  PLANNING_GET_RESEARCH_STATUS: 'rad-engineer:planning-get-research-status',
  PLANNING_GET_RESEARCH_FINDINGS: 'rad-engineer:planning-get-research-findings',
  PLANNING_GENERATE_PLAN: 'rad-engineer:planning-generate-plan',
  PLANNING_VALIDATE_PLAN: 'rad-engineer:planning-validate-plan',
  PLANNING_SAVE_PLAN: 'rad-engineer:planning-save-plan',
  PLANNING_UPDATE_PLAN: 'rad-engineer:planning-update-plan',

  // Planning events (main -> renderer)
  PLANNING_INTAKE_PROGRESS: 'rad-engineer:planning-intake-progress',
  PLANNING_RESEARCH_AGENT_UPDATE: 'rad-engineer:planning-research-agent-update',
  PLANNING_RESEARCH_COMPLETE: 'rad-engineer:planning-research-complete',
  PLANNING_PLAN_GENERATED: 'rad-engineer:planning-plan-generated',

  // VAC operations (Verification And Contracts)
  VAC_GET_ALL_CONTRACTS: 'rad-engineer:vac:get-all-contracts',
  VAC_GET_CONTRACT: 'rad-engineer:vac:get-contract',
  VAC_CREATE_CONTRACT: 'rad-engineer:vac:create-contract',
  VAC_UPDATE_CONTRACT: 'rad-engineer:vac:update-contract',
  VAC_DELETE_CONTRACT: 'rad-engineer:vac:delete-contract',
  VAC_RUN_VERIFICATION: 'rad-engineer:vac:run-verification',
  VAC_CHECK_DRIFT: 'rad-engineer:vac:check-drift',
  VAC_COMPARE_AST: 'rad-engineer:vac:compare-ast',
  VAC_GET_VERIFICATION_HISTORY: 'rad-engineer:vac:get-verification-history',
  VAC_GET_DRIFT_HISTORY: 'rad-engineer:vac:get-drift-history',

  // Learning operations (Meta-learning and EWC)
  LEARNING_GET_DECISION_HISTORY: 'rad-engineer:learning:get-decision-history',
  LEARNING_GET_ANALYTICS: 'rad-engineer:learning:get-learning-analytics',
  LEARNING_GET_PATTERNS: 'rad-engineer:learning:get-patterns',
  LEARNING_SEARCH_PATTERNS: 'rad-engineer:learning:search-patterns',
  LEARNING_GET_METHOD_EFFECTIVENESS: 'rad-engineer:learning:get-method-effectiveness',
  LEARNING_SELECT_METHOD: 'rad-engineer:learning:select-method',
  LEARNING_GET_OUTCOME_METRICS: 'rad-engineer:learning:get-outcome-metrics',
  LEARNING_EXPORT_REPORT: 'rad-engineer:learning:export-learning-report',
  LEARNING_GET_QUALITY_TRENDS: 'rad-engineer:learning:get-quality-trends',
  LEARNING_GET_EWC_CURVES: 'rad-engineer:learning:get-ewc-curves'
} as const;
